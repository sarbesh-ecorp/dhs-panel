...
export default function BannerContentBhankrota() {
    const { id } = useParams();
    ...
    const apiUrl = id === "house-system" 
        ? "" 
        : id === 'pravaah' ? "" : id === 'shiksha-kendra' ? '' : id === 'learner-centric-programmes' ? '' : id === 'our-school' ? "" : id === 'vision-n-mission' ? "" : '';
    ...
    return (
        <div className="mainContent">
            ...
            <div className="banner-header">
                <h3>{id === "house-system" 
        ? "House System" 
        : id === 'pravaah' ? "Pravaah" : id === 'shiksha-kendra' ? 'Shiksha Kendra' : id === 'learner-centric-programmes' ? 'Learner Centric Programmes' : id === 'our-school' ? "Our School" : id === 'vision-n-mission' ? "Vision & MIssion" : 'UNDEFINED'}</h3>
