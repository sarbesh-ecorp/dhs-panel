...
export default function BoardingFAQs() {
    ...
    return (
        <div className="mainContent">
            ...
            <div className="banner-card">
                <button className="btn btn-primary" onClick={() => navigate('/dhs-bhankrota/boarding-faq/new')}>Add FAQ</button>
                    ...
                    <tbody>
                        {faqData.map((faq, index) => (
                            <tr key={faq.id}>
                                ...
                                <td>
                                    <button className="btn btn-warning" onClick={() => navigate(`/dhs-bhankrota/boarding-faq/${faq.id}`)}><i className="fa fa-edit"></i></button>
                                </td>
                                <td>
