...
export default function BannerContentMultipleImageBhankrota() {
    const { id } = useParams();
    ...
    id === "school-campus"
    ? ""
    : id === "labs" ? '' : id === "sports" ? '' : id === 'other-facilities' ? '' : id === "boarding-house" ? '' : id === "scholarship" ? '' : id === 'pedagogy' ? '' : id === 'curriculum' ? '' : id === 'foreign-language' ? '' : id === 'visual-art' ? '' : id === 'performing-arts' ? '' : id === 'music' ? '' : id === 'sports' ? '' : id === 'health-n-wellness' ? '' : id === 'boarding-house' ? '' : id === 'a-day-in-life-of-boarder' ? '' : '' ;
        ...
        <div className="mainContent">
            ...
            <div className="banner-header">
                <h3>
                    { id === "school-campus"
    ? "School Campus"
    : id === "labs" ? 'Labs' : id === "sports" ? 'Sports' : id === 'other-facilities' ? 'Other Facilities' : id === "boarding-house" ? 'Boarding House' : id === "scholarship" ? 'Scholarship' : id === 'pedagogy' ? 'Pedagogy' : id === 'curriculum' ? 'Curriculum' : id === 'foreign-language' ? 'Foreign Language' : id === 'visual-art' ? 'Visual Art' : id === 'performing-arts' ? 'Performing Arts' : id === 'music' ? 'Music' : id === 'sports' ? 'Sports' : id === 'health-n-wellness' ? 'Health and Wellness' : id === 'boarding-house' ? 'Boarding House' : id === 'a-day-in-life-of-boarder' ? 'A Day in Life of Boarder' : 'UNDEFINED' }
                </h3>
