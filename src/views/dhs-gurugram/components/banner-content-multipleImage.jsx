...
export default function BannerContentMultipleImageGurugram() {
    const { id } = useParams();
    ...
    id === "school-campus"
    ? ""
    : id === "labs" ? '' : id === "sports" ? '' : id === 'other-facilities' ? '' : id === "primary" ? '' : id === 'pedagogy' ? '' : id === 'curriculum' ? '' : id === 'technology' ? '' : id === 'visual-art' ? '' : id === 'performing-arts' ? '' : id === 'music' ? '' : id === 'health-n-wellness' ? '' : '' ;
        ...
        <div className="mainContent">
            ...
            <div className="banner-header">
                <h3>
                    { id === "school-campus"
    ? "School Campus"
    : id === "labs" ? 'Labs' : id === "sports" ? 'Sports' : id === 'other-facilities' ? 'Other Facilities' : id === "primary" ? 'Primary' : id === 'pedagogy' ? 'Pedagogy' : id === 'curriculum' ? 'Curriculum' : id === 'technology' ? 'Technology' : id === 'visual-art' ? 'Visual Art' : id === 'performing-arts' ? 'Performing Arts' : id === 'music' ? 'Music' : id === 'health-n-wellness' ? 'Health and Wellness' : '' }
                </h3>
